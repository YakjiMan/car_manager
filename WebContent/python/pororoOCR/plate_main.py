...
def plate_check(plate_img):
    ...
    root_dir = 'E:/SHS/third_project/SHS/second_project/car_manager/WebContent/testpicture/num_img/' # 디렉토리
    ...
    save_road = "E:/SHS/third_project/SHS/second_project/car_manager/WebContent/testpicture/plate_save/" + park_time + "-" + result[0] + ".png"
