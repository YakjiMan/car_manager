...
<body>
	...
	<% 
		...
		String location = pageContext.getServletContext().getRealPath("/");
		location += "WebContent\\testpicture\\num_img";
		location = location.replace("\\.metadata\\.plugins\\org.eclipse.wst.server.core\\tmp0\\wtpwebapps","");
		...
		pythonbrowse py = new pythonbrowse();
		py.test();
		
		session.removeAttribute("move_no");
		session.removeAttribute("move_car");
